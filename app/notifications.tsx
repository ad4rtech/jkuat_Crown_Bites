...
import { X, CheckCircle2, Flame, Info, Trash2, AlertTriangle } from 'lucide-react-native';
    ...
    <View style={[styles.container, { paddingTop: insets.top + 10, paddingBottom: insets.bottom + 20 }]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        {notifications.length === 0 ? (
          <Text style={{ textAlign: 'center', color: '#8a7465', marginTop: 40 }}>No notifications to display.</Text>
        ) : (
...
const styles = StyleSheet.create({
  ...
  cardNew: {
    borderLeftWidth: 4,
    borderLeftColor: '#10b981', // Green left border
  },
  newIndicator: {
    position: 'absolute',
    top: 16,
